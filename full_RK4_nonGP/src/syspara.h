...
struct inastruct {
	...
	double *Tmss,*Ttaum,*Thss,*Ttauh_fast,*Ttauh_slow,*Ttauj;
	...
	*/
	...
	// temperture coefficent
	double Tfac;

	// Drug concentration for Flecanide or Lidocaine
	double Gna_fast,fast;
	double drug_charged,drug_neutral;
	double kon,koff,kcon,kcoff;
	double k_on,k_off,ki_on,ki_off,kc_on,kc_off;
	double kd0,kd_open;
	
	// Other parameters regarding Drug.
	double pH,pKa,portion,diffusion;

	// Tablization of EXP functions
		// Fast sodium currnet
		//double *Tam,*Tbm,*Tah,*Tbh,*Taj,*Tbj;
		double *Ta11,*Ta12,*Ta13,*Tb11,*Tb12,*Tb13,*Ta3,*Tb3,*Ta2;

	// Fast sodium current
	double a11,a12,a13,b11,b12,b13,a3,b3,a2,b2,ax,bx;
	double a13c,a13n,b13c,b13n;
	double ax1,ax2,bx1,bx2;
	double a22,a_22,a33,a_33,a44,a_44;
	double b22,b_22,b33,b_33,b44,b_44;
