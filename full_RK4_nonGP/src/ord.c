	...
	// Initialization time
		...
		//		if (var.pflag) orbit(&mode,x,dvdt_new);
				...
				//if (time>= 0.0){
					...
					//			time,x[0],ina.fast,ina.late,ito.ik,ikr.ik,iks.ik,ik1.ik,var.inaca,var.inaca_ss,ical.ica,inak.inak,inab.na,icab.ca,x[53],x[54],x[57],x[58],x[59],x[60]);
					//fprintf(fp2,"%lf %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e\n",
					//			time,x[0],x[21],x[22],x[23],x[24],x[25],x[26],x[27],x[28],x[29],x[30],
					//			x[31],x[32],x[33],x[34],x[35],x[36],x[37],x[38],x[39],x[40],
					//			x[41],x[42],x[43],x[44],x[45],x[46],x[47],x[48],x[49],x[50],
					//			x[51],x[52],x[53],x[54],x[55],x[56],x[57],x[58],x[59],x[60],var.Istim);
				}
